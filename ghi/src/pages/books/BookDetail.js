...
function BookDetail() {
  ...
  const bookBasicInfo = {
    ...
    summary:
      "Build a system for getting 1% better every day, Break your bad habits and stick to good ones,stick to good ones,  Avoid the common mistakes most people make when changing habits. Overcome a lack of motivation and willpower.Develop a stronger identity and believe in yourself. ",
  };
