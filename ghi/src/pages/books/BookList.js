    ...
    try{
      ...
      if(response.ok){
        ...
        const genresPromises = data.map(async (book) => {
            const genreResponse = await fetch(`http://localhost:8000/api/books/${book.id}/genres`);
        if (genreResponse.ok) {
    ...
    <div className="book-list-page">
      <div className="banner">
        <div className="banner-content">
          ...
          <p className="book-list-banner-paragraph">Lorem ipsum dolor sit amet, consectetur adipiscing elitmpor</p>
          <p className="book-list-banner-paragraph">Consectetur adipiscing elitmpor, ipsum dolor sit amet.</p>
