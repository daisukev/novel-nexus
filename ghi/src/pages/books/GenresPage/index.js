...
function GenresPage() {
    ...
    const color = ["#CA965C", "#BE8ABF", "#6D8B74", "#7286D3", "#FFB9B9",
        "#525E75", "#FF8787", "#6096B4", "#D7C0AE", "#DFCCFB", "#65647C",
        "#F0DD92", "#D57E7E", "#99A799", "#BA94D1", "#D1EAA3", "#AEE2FF",
        "#FFDDD2", "#EFB08C", "#F3C5C5", "#A7727D", "#FEBE8C", "#BBD6B8"]
            ...
            <div className='genre-display'>
                {
                    genres.map((eachGenre, index) => {
                        ...
                        return (
                            <Genre genre={eachGenre} color={eachColor} key={index}/>
                        )
                    })
                }
            </div>
