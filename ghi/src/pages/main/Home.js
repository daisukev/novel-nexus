        ...
        <div className="main-banner-content">
          <div className="main-intro-text">
            <h1 className="main-banner-header-text">
              Gateway to Literary Adventures
            </h1>
            <p className="main-text-paragraph">
              Where Stories Come to Life. Join us in exploring new worlds,
              uncovering hidden tales, and sharing your own.
            </p>
            <Link to="/books">
      ...
      <div className="top-sellers-section">
        ...
        <div className="top-seller-container">
          <div className="best-seller-card">
            <img src={recent2} alt="Book 1 Cover" className="best-seller-img" />
            <div className="best-seller-details">
              <p className="best-seller-title">Calculus Math Made Easy</p>
              <small>By Loren Josh</small>
              <div className="book-stars">4.9⭐</div>
              <button className="best-seller-btn">Buy</button>
            </div>
          </div>

          <div className="best-seller-card">
            <img src={recent9} alt="Book 1 Cover" className="best-seller-img" />
            <div className="best-seller-details">
              <p className="best-seller-title">Death Beside the Seaside</p>
              <small>By T.E Kinsey</small>
              <div className="book-stars">4.8⭐</div>
              <button className="best-seller-btn">Buy</button>
            </div>
          </div>
          <div className="best-seller-card">
            <img src={recent4} alt="Book 1 Cover" className="best-seller-img" />
            <div className="best-seller-details">
              <p className="best-seller-title">Software Agile</p>
              <small>By Json Edison</small>
              <div className="book-stars">4.7⭐</div>
              <button className="best-seller-btn">Buy</button>
            </div>
          </div>
          <div className="best-seller-card">
            ...
            />
            <div className="best-seller-details">
              <p className="best-seller-title">Poster Girl</p>
