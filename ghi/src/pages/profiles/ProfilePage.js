        ...
        <div className="profile-header">
            {author && (
                <div className="profile-bio-container">
                    ...
                    <h3 className="profile-bio">Name: {`${author.first_name} ${author.last_name}`}</h3>
   ...
   <div className="author-profile-content-page">
            ...
            <div className="content-container flex-margin">
                    <div className="grid-wrapper">
                        {activeContent === 'recent' && recentChapters && recentChapters.chapters

                        .filter(chapter => {
                            const associatedBook = books.find(book => book.id === chapter.book_id && book.author_id === authenticatedUser.id )
                        ...
                        .map((chapter) => {
                             const associatedBook = books.find(book => book.id === chapter.book_id  && book.author_id === authenticatedUser.id);
                             return (
                                <div key={chapter.id} className="author-content-grid-card" >
                                <img src={associatedBook ? associatedBook.cover : 'default-image-path.jpg'} alt={`${chapter.title} image`} className="chapter-image" />
                                <div>
                      ...
                      {activeContent === 'books' && books && books
                      .filter(book => book.author_id === authenticatedUser.id)

                      .map((book) => (
                            <div key={book.id} className="author-content-grid-card"  >
                                <Link to={`/books/${book.id}`}><img src={book.cover} alt={`${book.title} image`} className="chapter-image" /></Link>
                                <div>
...
<ul className="professional-affiliation">
    <li>
        <img src="https://www.un.org/youthenvoy/wp-content/uploads/2014/09/unicef_twitter1.png" alt="XYZ Writers' Guild Logo" />
        UNICEF
    </li>
    <li>
        <img src="https://www.filepicker.io/api/file/wAKB3DXWRyWSckw1lXCg" alt="ABC Literary Society Logo" />
       Writing Club
    </li>
</ul>
</div>
<div className="profile-sidebar flex-margin">
    ...
    <ul className="featured-group-list">
        <li><a href="#"><i className="featured-list"></i></a>blah</li>
        <li><a href="#"><i className="featured-list"></i></a>blah</li>
        <li><a href="#"><i className="featured-list"></i></a>blah</li>
        <li><a href="#"><i className="featured-list"></i></a>blah</li>
        </ul>
